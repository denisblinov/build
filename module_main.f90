...
SUBROUTINE array_def( def )
    ...
    WRITE (*,'(a25,3x,i2.2,a1,i2.2,2x,i2.2)') 'day and time delivery for term 00', def(8),':',def(9), def(7)
    WRITE (*,'(a25,3x,i2.2,a1,i2.2,2x,i2.2)') 'day and time delivery for term 12',def(11),':',def(12),def(10)
