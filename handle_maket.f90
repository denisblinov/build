...
!------------------------------------------------------------------
  ...
  CASE( 'SYNOPMAK','SYNOPDOP')
    ...
    ! Â áàçå âñòðå÷àþòñÿ çíà÷åíèÿ îñàäêîâ, ðàâíûå +9990. 
    ! ïðèõîäèòñÿ èõ ïðèðàâíèâàòü ê êîíñòàíòå îòñóòñòâèÿ.
    WHERE( value_field(29:31,:,t) == 9990.0 ) value_field2(29:31,:,t)=oundef
    ! Â áàçå âñòðå÷àþòñÿ çíà÷åíèÿ îáëà÷íîñòè, ðàâíîå 99 
    ! ïðèõîäèòñÿ å¸ ïðèðàâíèâàòü ê êîíñòàíòå îòñóòñòâèÿ.
    WHERE( value_field(18,:,t) == 99.0 ) value_field2(18,:,t)=oundef
    ! Çàäàòü çíàê òåíäåíöèè ñîãëàñíî ÊÍ-01
    WHERE( value_field(14,:,t) > 4.0 ) value_field2(15,:,t)=-value_field2(15,:,t)

    ! Öèêë äëÿ ïîäñòàíîâêè êîîðäèíàò èç ñëîâàðÿ
    DO j=1,NY
      DO jj=1,17000
      ...
      ENDDO
    ENDDO
! Çàêîììåíòèðîâàë, òàê êàê ýòî èñïðàâèëè.
!!     Âðó÷íóþ óñòàíîâèòü âûñîòó ñòàíöèè Øåðåìåòüåâî
       WHERE( ListSt(:)==27514 ) value_field2(5,:,t)=187
!!     Âðó÷íóþ óñòàíâëåíû âûñîòû 4 ñòàíöèé â Øâåäöèè, òàê êàê òàì íåçàäàíà âûñîòà
...
!     string Type(Sr) RaRaSaSa OSurf OTropop OmaxW" 
  ...
  CASE( 'SHIPBMAK' )
    ...
    ! îòðèöàòåëüíûå çíà÷åíèÿ - ýòî çàáðàêîâàííûå äàííûå çàäà÷åé OASYN
    WHERE( value_field(8:13,:,t) < 0 )  value_field2(8:13,:,t) = oundef
    ! Â áàçå âñòðå÷àþòñÿ çíà÷åíèÿ îáëà÷íîñòè, ðàâíîå 99
    ! ïðèõîäèòñÿ å¸ ïðèðàâíèâàòü ê êîíñòàíòå îòñóòñòâèÿ.
    WHERE( value_field(18,:,t) == 99.0 ) value_field2(18,:,t) = oundef
  ...
  CASE( 'AIREPMAK')
    ...
    END FORALL
    ! îòðèöàòåëüíûå çíà÷åíèÿ - ýòî çàáðàêîâàííûå äàííûå çàäà÷åé CONTREL
  ...
  ! Çàìåíà âõîäíîé êîíñòàíòû îòñóòñòâèÿ äàííûõ íà âûõîäíóþ
